...
public class RoutePlanDemo extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// latitude + " " + longitude + " " + city, 0).show();
		// latLng2 = new LatLng(latitude, longitude);
		// end.setText(adress);
		// enNode = PlanNode.withLocation(latLng2);
		// Poisearch.isfirst=false;
		// }
		// 处理搜索按钮响应
	...
	public void routeinfo(View view) {
		...
		Intent intent = new Intent(RoutePlanDemo.this, Rountplan.class);
